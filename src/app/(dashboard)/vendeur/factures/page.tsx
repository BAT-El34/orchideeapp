...
export default async function VendeurFacturesPage() {
  ...
  return <InvoicesList invoices={(invoices as any) ?? []} role={profile.role as any} newHref="/vendeur/factures/nouvelle" />
}
